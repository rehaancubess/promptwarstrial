...
export default function VoiceDoctor({ user }) {
            ...
            case "text":
              setTranscript((prev) => {
                ...
                if (last && last.role === "doctor") {
                  return [
                    ...prev.slice(0, -1),
                    { role: "doctor", text: last.text + msg.data },
                  ];
                }
  ...
  return (
    <div className="voice-fullscreen-container">
      <div
        className="voice-fullscreen-panel"
        role="region"
        aria-label="Voice Doctor Interface"
      >
        {/* Header */}
        ...
        >
          {transcript.length === 0 && (
            <div className="voice-empty-state">
              <Activity
                size={48}
                className="mb-4 opacity-40 mx-auto"
                style={{ color: "var(--red)" }}
              />
              <p
              ...
              >
                Hi! Press the microphone button below to start talking to Dr.
                Hemora.
                <br />
                <br />
                The doctor is ready to review your recent labs, explain your
                metrics, and answer your wellness questions.
              </p>
            </div>
          )}
